...
const init = async () => {
  ...
  // get minhealth covid locations (server-side and git-based)
  // const locations = await fetchJSON('./geojson/locations-of-interest.geojson');

  // get minhealth covid locations (client-side and github-based)
  const locationsURL =
  ...
  for (l of locations.features) {
    ...
    osmb.addOBJ(
      `${location.href}obj/frog/frog.obj`,
      {
        // latitude: -36.85436,
        // longitude: 174.75717
        latitude: l.geometry.coordinates[1],
  ...
  // const skull = await fetchObj('obj/skull/skull.obj');
  // console.log('skull: ', skull);
  // console.log(`${location.href}obj/skull/skull.obj`);
